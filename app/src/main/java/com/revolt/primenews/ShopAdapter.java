...
public class ShopAdapter extends RecyclerView.Adapter<ShopAdapter.RecyclerViewHolder>{
    ...
    public ShopAdapter(Context context, List<Taxi> uploads) {
        mContext = context;
        teachers = uploads;
    }
    ...
    public ShopAdapter.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ShopAdapter.RecyclerViewHolder(v);
    }
    @Override
    public void onBindViewHolder(final ShopAdapter.RecyclerViewHolder holder, int position) {
