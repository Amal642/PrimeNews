...
public class SevanamFullAdapter  extends RecyclerView.Adapter<SevanamFullAdapter.RecyclerViewHolder>{

    private Context mContext;
    private List<Taxifull> teachers;
    String entity;
    public SevanamFullAdapter(Context context, List<Taxifull> uploads, String name) {
        mContext = context;
        teachers = uploads;
        entity=name;
    }
    ...
    @Override
    public SevanamFullAdapter.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.row_model4, parent, false);
        return new SevanamFullAdapter.RecyclerViewHolder(v);
    }
    @Override
    public void onBindViewHolder(final SevanamFullAdapter.RecyclerViewHolder holder, int position) {
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child("Sevanams").child(entity)
