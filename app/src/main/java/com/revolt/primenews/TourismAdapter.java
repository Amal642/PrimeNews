...
public class TourismAdapter extends RecyclerView.Adapter<TourismAdapter.RecyclerViewHolder> {

    private Context mContext;
    private List<Tourism> teachers;
    private TourismAdapter.OnItemClickListener mListener;

    public TourismAdapter(Context context, List<Tourism> uploads) {
        mContext = context;
        teachers = uploads;
    }
