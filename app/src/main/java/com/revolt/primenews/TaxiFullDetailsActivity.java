...
public class TaxiFullDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taxi_full_details);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(TaxiFullDetailsActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
